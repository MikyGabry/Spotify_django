...
urlpatterns = [
    ...
    path('artist/<int:pk>/songs/new', views.SongCreate.as_view(), name="song_create"),
    path('playlist/<int:pk>/songs/<int:song_pk>/', views.PlaylistSongAssoc.as_view(), name="playlist_song_assoc"),
]